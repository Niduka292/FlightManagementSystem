...
public class BookingDTO {
    ...
    public BookingDTO(CustomerDTO customer, 
        ...
        String index;
        if(bookingIdIndex < 10){
            index = "000"+bookingIdIndex;
        }else if(bookingIdIndex < 100){
            index = "00"+bookingIdIndex;
        }else{
            index = String.valueOf(bookingIdIndex);
        }
        
        bookingID = flight.getFlightID()+"-"+bookingIdIndex; // Auto generate bookingID
